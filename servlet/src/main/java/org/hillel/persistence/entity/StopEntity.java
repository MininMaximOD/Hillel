...
public class StopEntity extends AbstractModifyEntity<Long> implements Serializable{
    ...
    @OneToOne(mappedBy = "stop", cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
    private StopAdditionalInfoEntity additionalInfo = new StopAdditionalInfoEntity();
    ...
    public void removeStopAdditionalInfo(){
